...
export const ui = {
  en: {
    ...
    "home.profession": "Backend developer",
    "home.location": "Based in Colombia",
    "home.description.p1":
    ...
    "home.description.p4":
      "When I'm not behind a screen, I'm probably riding my motorcycle to some small town nearby. I also picked up photography along the way, turns out the best moments happen when you're not looking at code.",
    ...
    "work.description": "Places I've worked and what I did there.",

    "projects.title": "Projects",
    "projects.description": "Personal projects and small experiments.",
  ...
  es: {
    ...
    "home.profession": "Desarrollador Backend",
    "home.location": "Desde Colombia",
    "home.description.p1":
    ...
    "home.description.p4":
      "Cuando no estoy frente a la pantalla, probablemente voy en moto camino a algún pueblito cercano. También descubrí la fotografía en el camino, resulta que los mejores momentos pasan cuando no estás mirando código.",
    ...
    "work.description": "Lugares donde he trabajado y qué hice ahí.",

    "projects.title": "Proyectos",
    "projects.description": "Proyectos personales y pequeños experimentos.",
